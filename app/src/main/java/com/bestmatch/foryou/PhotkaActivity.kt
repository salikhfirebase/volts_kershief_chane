...
class PhotkaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        the_imgHolder = findViewById(R.id.vibrannaya_fotka_iview)
        the_takePicButt = findViewById(R.id.snyat_button)
        the_selectImgButton = findViewById(R.id.vibrat_photo_button)
