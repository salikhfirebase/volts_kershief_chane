...
class RedaktirovanieProfilyaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        the_userNick = findViewById(R.id.nick_et_glavnaya)
        the_userMakeClear = findViewById(R.id.proyasnit_field)
        the_yearsSpinner = findViewById(R.id.god_spinner)
        the_daysSpinner = findViewById(R.id.dni_spinner)
        the_monthsSpinner = findViewById(R.id.mesyac_spinner)
        the_raceSpinner = findViewById(R.id.rasa_spinner_glavnaya)
        the_heightSeek = findViewById(R.id.visota_bar)
        ...
        the_checkedHaveHouse = findViewById(R.id.est_dom_tview)
        the_checkedHaveCar = findViewById(R.id.yest_mashina_tview)
        the_checkedHaveMoto = findViewById(R.id.est_motorcicle_tview)
        ...
        the_saveButton.setOnClickListener {
            ...
            Completable.fromAction { db.userDao().update(the_user) }
                ...
                .subscribe({
                    ...
                    the_intent1 = Intent(this, LichniyKabinetActivity::class.java)
