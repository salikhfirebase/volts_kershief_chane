...
import com.bestmatch.foryou.LichniyKabinetActivity
...
class VhodFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        the_emailEditText = view.findViewById(R.id.pochta_et_vhod)
        the_passEditText = view.findViewById(R.id.parol_et_vhod)
    ...
    fun isUserInDb(email: String, password: String) {
        ...
        Observable.fromCallable{ db.userDao().verifaicate(email,password) }
            ...
            .subscribe {
                if (it>0) {
                    the_intent1 = Intent(this.requireContext(), LichniyKabinetActivity::class.java)
