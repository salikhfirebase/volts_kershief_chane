...
import com.bestmatch.foryou.fragments.OstalnayaInfaFragment
import com.bestmatch.foryou.fragments.PolitikaFragment
...
class LichniyKabinetActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        the_intent1 = Intent(this, RedaktirovanieProfilyaActivity::class.java)
        the_fragmentMain = OstalnayaInfaFragment()
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_help -> {
                the_fragmentMain = PolitikaFragment()
                setFragment(the_fragmentMain)
            }

            R.id.nav_sign_out -> {
                the_menuIntent = Intent(this, GlavnayaActivity::class.java)
