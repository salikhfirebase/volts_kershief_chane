...
import kotlinx.android.synthetic.main.activity_personal_cabina.*
import kotlinx.android.synthetic.main.app_bar_user_profile.*
import volts.kershief.chane.db.AppDatabase
import volts.kershief.chane.fragments.OtherPamPamFragment
import volts.kershief.chane.fragments.PolicyMainFragment

class PersonalCabinaActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_personal_cabina)
        ...
        the_intent1 = Intent(this, MyPersonalProfileEditActivity::class.java)
        the_fragmentMain = OtherPamPamFragment()
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_help -> {
                the_fragmentMain = PolicyMainFragment()
                setFragment(the_fragmentMain)
            }

            R.id.nav_sign_out -> {
                the_menuIntent = Intent(this, MainSamatActivity::class.java)
