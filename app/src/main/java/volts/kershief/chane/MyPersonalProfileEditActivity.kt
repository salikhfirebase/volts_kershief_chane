...
class MyPersonalProfileEditActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_my_presonal_profile_edit)
        ...
        the_userNick = findViewById(R.id.nick_edit_text_prampam)
        the_userMakeClear = findViewById(R.id.always_wanted_to_say_tview)
        the_yearsSpinner = findViewById(R.id.years_trista_spiiner)
        the_daysSpinner = findViewById(R.id.days_word_spinner)
        the_monthsSpinner = findViewById(R.id.monthes_yes_spinner)
        the_raceSpinner = findViewById(R.id.race_spinner_for_three_races)
        the_heightSeek = findViewById(R.id.height_bar_seek_users)
        the_weightSeek = findViewById(R.id.weight_seek_bar_users)
        the_heightText = findViewById(R.id.chosen_height_by_user_tview)
        the_weightText = findViewById(R.id.weight_chosen_by_user_bar)
        the_saveButton = findViewById(R.id.profile_edit_save_button)
        the_radioGroup = findViewById(R.id.edit_radioGroup)
        the_checkedHaveHouse = findViewById(R.id.have_house_thanks)
        the_checkedHaveCar = findViewById(R.id.have_car_yes_i_do)
        the_checkedHaveMoto = findViewById(R.id.have_moto_thanks_yes)
