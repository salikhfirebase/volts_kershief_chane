...
class PictureSetupQActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_picture_setup_q)

        the_imgHolder = findViewById(R.id.chosen_by_user_lol_picture)
        the_takePicButt = findViewById(R.id.take_a_user_picture_button)
        the_selectImgButton = findViewById(R.id.choose_pic_from_gallery_by_user)
        the_nextButton = findViewById(R.id.picture_setuo_next_button)
